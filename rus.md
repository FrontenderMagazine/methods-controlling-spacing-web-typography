...
Здесь нам поможет свойство [`word-spacing`][14], которое, к тому же, отлично поддерживается браузерами. Вот отрывок текста, набранный шрифтом [Prompt][15], который несколько шире большинства и в данном случае текст будет выглядеть лучше, если немного подкорректировать расстояния между словами.
...
Многим из нас, веб-дизайнеров, не нравится зависеть от интерпретации наших типографических решений системой.
...
Нет недостатка в спорах допустимо ли играть с субпиксельным сглаживанием. Несмотря на то, что несколько лет назад Дмитрий Фадеев [резюмируя его аргументы][22] красиво высказался против этой практики.
...
* `antialiased`: Сглаживает шрифт на том же уровне, что уже обеспечивается системой
...
Типографика в вебе — это сложно! Да, мы можем контролировать то, как разные символы отображаются, отрисовываются и позиционируются на экране. Но с великой силой приходит великая ответственность. Теперь в вашем распоряжении есть по меньшей мере несколько приемов, как отвечать веб-дизайнерам, которые зациклены на точности типографического дизайна в браузере.
